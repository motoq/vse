...
/**
 * Defines an interface for accessing the position of an object in
 * 3 dimensional space.
 * 
 * @author   Kurt Motekew
 * @since    20110221
...
public interface IPosition {
  ...
  /**
   * @param   t     Input:  The time for which the position should
   *                        be retrieved.
   *
   * @param   pos   Output:  The position is copied into this variable.
   *
